<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Wallets.aspx.cs" Inherits="products_Wallets" %>
...
<div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT Products.ProductID, Products.ProductName, Products.Price, ProductPictures.ThumbURL FROM Products INNER JOIN ProductPictures ON Products.ImageName = ProductPictures.ImageName WHERE (Products.Category = 2)"></asp:SqlDataSource>
