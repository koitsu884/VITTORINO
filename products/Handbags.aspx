<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Handbags.aspx.cs" Inherits="products_Handbags" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT Products.ProductID, Products.ProductName, Products.Price, ProductPictures.ThumbURL FROM Products INNER JOIN ProductPictures ON Products.ImageName = ProductPictures.ImageName WHERE (Products.Category = 1)"></asp:SqlDataSource>
