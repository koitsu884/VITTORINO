<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Cardcases.aspx.cs" Inherits="products_Cardcases" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT Products.ProductID, Products.ProductName, Products.Price, ProductPictures.ThumbURL FROM Products INNER JOIN ProductPictures ON Products.ImageName = ProductPictures.ImageName WHERE (Products.Category = 3)"></asp:SqlDataSource>
